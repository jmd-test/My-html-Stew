html_test = "<html><div><a>hi nigeria</a><img src='some link idk'/></div></html>"
...
class MessyStew:
    ...
    def find(self,tag_name,brick_attribute):
        scavenge_babies(FATHER_brick,tag_name,brick_attribute)
            

#test stuff HERE PLEASE ■■■■■■■■■■■■■■■■ 
test = MessyStew("https://pornhub.com")
test.find("div","data")